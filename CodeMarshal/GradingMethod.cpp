...
void solve()
{
    ...
    else if(n>=80 && n<=89) cout<<"A"<<endl;
    else if(n>=70 && n<=79) cout<<"A-"<<endl;
    else if(n>=60 && n<=69) cout<<"B+"<<endl;
    else if(n>=50 && n<=59) cout<<"B-"<<endl;
    else if(n>=40 && n<=49) cout<<"C"<<endl;
    else if(n>=35 && n<=39) cout<<"D"<<endl;
    else cout<<"F"<<endl;
}
